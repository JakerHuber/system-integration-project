...
![project completion](/diagrams/project_completion_sprint_05.png)
![project userstory](/diagrams/user_story_sprint_05.png)
...
| --- | ---- | ------ | --------------- |
| <ul><li>- [x] </li></ul> | 1.1 Create Sprint report 05 template | [1.1 Create Sprint-05 Template](https://trello.com/c/7KT5uCYC) | [sprint-05.md](https://github.com/JakerHuber/system-integration-project/blob/master/reports/sprint-05/sprint-05.md) |
| <ul><li>- [x] </li></ul> | 1.2 Write sprint report 05 | [1.2 Write sprint report 05](https://trello.com/c/SGsA07zK) | [sprint-05.md](https://github.com/JakerHuber/system-integration-project/blob/master/reports/sprint-05/sprint-05.md) |
...
| <ul><li>- [x] </li></ul> | 1.4 Update Install.md | [1.4 Update Install.md](https://trello.com/c/k7KptAUv) | [installd.md](https://github.com/JakerHuber/system-integration-project/blob/master/install.md) |
...
|     | Goal | Trello | Github Artifact |
| --- | ---- | ------ | --------------- |
| <ul><li>- [x] </li><ul>  | 2.1 Code Usable UI | [2.1 Code Usable UI](https://trello.com/c/RlsnL0Kb) | [/fakebtchapp/fakebtch](https://github.com/JakerHuber/system-integration-project/tree/master/fakebtchapp/fakebtch) |
| <ul><li>- [x] </li></ul> | 2.2 Test UI usability | [2.2 Test UI usability](https://trello.com/c/DOA1TYQg) | [/fakebtchapp/fakebtch](https://github.com/JakerHuber/system-integration-project/tree/master/fakebtchapp/fakebtch) |
| <ul><li>- [x] </li></ul> | 2.3 Aid in Django Skeleton Setup | [2.3 Aid in Django Skeleton Setup](https://trello.com/c/1FyV2YBD) | [/fakebtchapp/fakebtch](https://github.com/JakerHuber/system-integration-project/tree/master/fakebtchapp/fakebtch) |
| <ul><li>- [x] </li></ul> | 2.4 Admin UI | [2.4 Admin UI](https://trello.com/c/tjwUnb2x) |  [admin.py](https://github.com/JakerHuber/system-integration-project/blob/master/fakebtchapp/fakebtch/admin.py) |
| <ul><li>- [x] </li></ul> | 2.5 List Bugs/Issues | [2.5 List Bugs/Issues](https://trello.com/c/3EYAYd5k) | [sprint-5.md](https://github.com/JakerHuber/system-integration-project/blob/master/reports/sprint-05/sprint-05.md) |
...
![login](https://github.com/JakerHuber/system-integration-project/blob/master/images/newlogin.png)
![creation](https://github.com/JakerHuber/system-integration-project/blob/master/images/createuser.png)
![home](https://github.com/JakerHuber/system-integration-project/blob/master/images/userhome.png)
...
|     | Goal | Trello | Github Artifact |
| --- | ---- | ------ | --------------- |
| <ul><li>- [x] </li></ul> | 3.1 Updated .gitignore | [Updated .gitignore](https://trello.com/c/lcHw7p3g) | [.gitignore](https://github.com/JakerHuber/system-integration-project/blob/master/.gitignore) |
| <ul><li>- [x] </li></ul> | 3.2 Automated vagrant / updated build file | [Automated vagrant / updated build](https://trello.com/c/kMxJahih) | [ubuntu18044-vanilla.json](https://github.com/JakerHuber/system-integration-project/blob/master/packer/build/ubuntu18044-vanilla.json) |
| <ul><li>- [x] </li></ul> | 3.3 Automated pulling of our repo | [Automated pulling of our repo](https://trello.com/c/ztBdYnGx) | [ubuntu18044-vanilla.json](https://github.com/JakerHuber/system-integration-project/blob/master/packer/build/ubuntu18044-vanilla.json) |
| <ul><li>- [x] </li></ul> | 3.4 Automated app deployment with post_install script | [Automated app deployment with post_install script](https://trello.com/c/XIl7ZAex) | [post_install_vagrant.sh](https://github.com/JakerHuber/system-integration-project/blob/master/packer/scripts/post_install_vagrant.sh) |
| <ul><li>- [x] </li></ul> | 3.5 Updated database deployment and encryption| [Updated database deployment and encryption](https://trello.com/c/aIsA80Q2) | [settings.py](https://github.com/JakerHuber/system-integration-project/blob/master/fakebtchapp/settings.py) |
...
<p align="center"><a href=""><img src="/images/reports_sprint5_sr_dev_task_1.png" alt="" height=auto width=auto></a></p>
...
<p align="center"><a href=""><img src="/images/reports_sprint5_sr_dev_task_3.png" alt="" height=auto width=auto></a></p>
...
|     | Goal | Trello | Github Artifact |
| --- | ---- | ------ | --------------- |
| <ul><li>- [x] </li></ul> | 4.1 Populate user accounts | [Populate user accounts](https://trello.com/c/TuDvWB4c) | [/diagrams/1.png](https://github.com/JakerHuber/system-integration-project/blob/master/diagrams/1.png) |
| <ul><li>- [x] </li></ul> | 4.2 Test packer/vagrant deployment | [Test packer/vagrant deployment](https://trello.com/c/gdLkkjCe) | [vagrant.png](https://github.com/JakerHuber/system-integration-project/blob/master//images/vagrant.png) |
| <ul><li>- [x] </li></ul> | 4.3 Load balancing/server configuration | [load balancing/server configuration](https://trello.com/c/gdLkkjCe) | [server.png](https://github.com/JakerHuber/system-integration-project/blob/master/images/server.png") |
| <ul><li>- [x] </li></ul> | 4.4 Database Diagram | [Database Diagram](https://trello.com/c/hb40s2wX) | [database_schema_diagram.png](https://github.com/JakerHuber/system-integration-project/blob/master/diagrams/database_schema_diagram.png) |
| <ul><li>- [x] </li></ul> | 4.5 List IT assumptions | [List IT assumptions](https://trello.com/c/7fHjsHQI) | [sprint-5.md](https://github.com/JakerHuber/system-integration-project/blob/master/reports/sprint-05/sprint-05.md) |
...
|     | Goal | Trello | Github Artifact |
| --- | ---- | ------ | --------------- |
| <ul><li>- [x] </li></ul> | 5.1 Test packer/vagrant build | [Test packer/vagrant build](https://trello.com/c/F0F42pzG) | [vagranttest.PNG](https://github.com/JakerHuber/system-integration-project/blob/master/images/vagranttest.PNG) |
| <ul><li>- [x] </li></ul> | 5.2 Test Login Fucntionality | [Test Login Fucntionality](https://trello.com/c/uNkUvbQM) | [sprint-05.md](https://github.com/JakerHuber/system-integration-project/blob/master/reports/sprint-05/sprint-05.md) |
| <ul><li>- [x] </li></ul> | 5.3 Create virtual environment  | [Create virtual environment](https://trello.com/c/WsIn1Mri) | [virtualenv.PNG](https://github.com/JakerHuber/system-integration-project/blob/master/images/virtualenv.PNG) |
| <ul><li>- [x] </li></ul> | 5.4 List bugs/issues found | [List bugs/issues found](https://trello.com/c/tVaRGwAV) | [sprint-05.md](https://github.com/JakerHuber/system-integration-project/blob/master/reports/sprint-05/sprint-05.md) |
| <ul><li>- [x] </li></ul> | 5.5 List Security Assumptions | [List Security Assumptions](https://trello.com/c/jPfPcSTj) | [sprint-05.md](https://github.com/JakerHuber/system-integration-project/blob/master/reports/sprint-05/sprint-05.md) |
